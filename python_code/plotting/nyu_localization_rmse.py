...
if __name__ == "__main__":
    ...
    params6 = {'K': [18], 'Nr': [4], 'fc': [6000], 'BW': [2], 'band_type': 'SINGLE'}
    params12 = {'K': [24], 'Nr': [8], 'fc': [12000], 'BW': [4], 'band_type': 'SINGLE'}
    params18 = {'K': [30], 'Nr': [12], 'fc': [18000], 'BW': [8], 'band_type': 'SINGLE'}
    params24 = {'K': [36], 'Nr': [16], 'fc': [24000], 'BW': [12], 'band_type': 'SINGLE'}
